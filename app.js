...
import { ShoppingBag, User, X, Instagram, Menu, ArrowRight } from 'lucide-react';

// --- STYLING & FONTS ---
// Add these fonts to your index.html or CSS import:
// @import url('https://fonts.googleapis.com/css2?family=Anton&family=Space+Grotesk:wght@300;400;700&display=swap');
// font-anton is the "Funky" font.
// font-grotesk is the "Subtle" font.
...
const CURRENT_DROP = {
  ...
  image: "https://images.unsplash.com/photo-1556821840-3a63f95609a7?q=80&w=1000&auto=format&fit=crop", // Placeholder
  stock: 50
};
...
const Countdown = () => {
  ...
  useEffect(() => {
    ...
    const calculateTime = () => {
      ...
      nextTuesday.setHours(12, 0, 0, 0); // Drop at 12:00 PM
